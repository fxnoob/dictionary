  ...
  return (
    <>
      ...
      <div className={classes.root}>
          ...
          <ListItem>
            ...
            <ListItemSecondaryAction>
              <Switch
                ...
                inputProps={{
                  "aria-label": "Set Dictionary popup visibility on webpage.",
                }}
              />
            </ListItemSecondaryAction>
          </ListItem>
        ...
        >
          <ButtonGroup variant="text" color="primary" aria-label="Support">
            <Button href={Constants.support.uninstallFeedbackForm}>
              Website
            </Button>
            <Button target="_blank" href={Constants.support.premium}>
              Go Premium
            </Button>
